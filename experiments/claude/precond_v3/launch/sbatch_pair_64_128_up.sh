...
#SBATCH --job-name=pcv3_up_64_128
#SBATCH --output=/math/home/fkiewiet/Freq2Transfer/experiments/claude/precond_v3/launch/logs/pcv3_up_64_128_%j.log
#SBATCH --error=/math/home/fkiewiet/Freq2Transfer/experiments/claude/precond_v3/launch/logs/pcv3_up_64_128_%j.err
...
CONFIG="$ROOT/experiments/claude/precond_v3/configs/pair_64_128.yaml"
OVERRIDE_CONFIG="$ROOT/experiments/claude/precond_v3/configs/live/pair_64_128_override.yaml"
...
echo "  $RUN_ROOT/pair_64_128/T_up/best.pt"
echo "  $RUN_ROOT/pair_64_128/T_up/last.pt"
echo "  $RUN_ROOT/pair_64_128/T_up/log.csv"
echo "  $RUN_ROOT/pair_64_128/T_up/summary.json"
