#!/usr/bin/env bash
# ══════════════════════════════════════════════════════════════════════════════
# wave6_N4800_final.sh — N=4800 final run, DOWN direction, λ_imag=1.0
# Run on: wave6.mit.edu
#
...
#   ssh wave6.mit.edu
#   cd ~/Freq2Transfer
#   bash experiments/claude/launch/wave6_N4800_final.sh
# ══════════════════════════════════════════════════════════════════════════════
set -euo pipefail
...
LOG="${LOG_DIR}/wave6_final_dn_N4800_${TS}.log"

mkdir -p "${LOG_DIR}" "${RESULTS_DIR}"

[[ -d "${SRC_DS}" ]] || { echo "ERROR: source dataset not found: ${SRC_DS}"; exit 1; }

WRAPPER="${LOG_DIR}/wave6_final_dn_N4800_${TS}.sh"
...
echo ""
echo "[wave6_N4800_final.sh] Job launched."
