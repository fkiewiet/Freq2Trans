#!/bin/bash
# Short-walltime queue probe for the 16->32 baseline.
# Purpose: test whether a materially shorter walltime starts earlier on ORCD.
# Training setup is intentionally kept the same except for:
#   - Slurm walltime: 6h
#   - trainer runtime cap: 5.5h

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
ROOT="$(cd "$SCRIPT_DIR/../../../.." && pwd)"
LOG_DIR="$ROOT/experiments/claude/precond_v3/launch/logs"

#SBATCH --job-name=pcv3_16_32_s6h
#SBATCH --output=/math/home/fkiewiet/Freq2Transfer/experiments/claude/precond_v3/launch/logs/pcv3_up_16_32_s6h_%j.log
#SBATCH --error=/math/home/fkiewiet/Freq2Transfer/experiments/claude/precond_v3/launch/logs/pcv3_up_16_32_s6h_%j.err
...
echo "========================================================"
echo "precond_v3 single-pair ORCD run (short queue probe)"
