...
echo "  src : /math/home/fkiewiet/Freq2Transfer/experiments/claude/datasets/up_N4800_seed42"
echo "  dst : /tmp/freq2t_up_N4800_seed42"
...
time /math/home/fkiewiet/Freq2Transfer/.venv/bin/python /math/home/fkiewiet/Freq2Transfer/experiments/claude/train_transfer.py \
    ...
    --outdir      /math/home/fkiewiet/Freq2Transfer/experiments/claude/results_transfer/final_up_N4800_k3_limag10 \
    --device      cuda:3 \
    --lambda_imag 1.0 \
    --kernel      3 \
    --batch_size  8 \
    --n_dl_workers 4 \
    --no_early_stop \
    2>&1 | tee '/math/home/fkiewiet/Freq2Transfer/experiments/claude/launch/logs/wave7b_final_up_N4800_20260318_153010.log'
