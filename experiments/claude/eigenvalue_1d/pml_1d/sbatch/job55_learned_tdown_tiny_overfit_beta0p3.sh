...
echo "conditioning=$CONDITIONING target_kind=$TARGET_KIND width=$WIDTH batch=$BATCH lr=$LR min_lr=$MIN_LR call_indices=${CALL_INDICES:-all} val_same_as_train=$VAL_SAME_AS_TRAIN val_max_problems=$VAL_MAX_PROBLEMS val_max_pairs=$VAL_MAX_PAIRS"
