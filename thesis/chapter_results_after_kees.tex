...
preconditioner. In the 2D experiments, full-grid FD/PML training improves the
finite-budget true-residual trajectory, but the CSL-preconditioned residual is
not uniformly improved. This is the main remaining limitation.
